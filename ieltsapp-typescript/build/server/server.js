...
function normalizeTfngAnswer(value) {
    ...
    if (normalized === 'true' || normalized === 'yes' || normalized === 't' || normalized === 'y')
        return 'True';
    if (normalized === 'false' || normalized === 'no' || normalized === 'f' || normalized === 'n')
        return 'False';
    if (normalized === 'notgiven' || normalized === 'ng')
        return 'Not Given';
    return null;
}
